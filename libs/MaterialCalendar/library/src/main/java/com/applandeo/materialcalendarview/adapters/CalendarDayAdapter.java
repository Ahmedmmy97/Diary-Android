...
class CalendarDayAdapter extends ArrayAdapter<Date> {
    ...
    private void setLabelColors(TextView dayLabel, Calendar day) {
        ...
        Stream.of(mCalendarProperties.getEventDays()).filter(eventDate ->
            ...
            DayColorsUtils.setEventDayColors(dayLabel, mCalendarProperties);
        });
    }
    ...
    private void loadIcon(ImageView dayIcon, Calendar day,TextView dayLabel) {
      ...
      /*  if (mCalendarProperties.getEventDays() == null ) {
        ...
        Stream.of(mCalendarProperties.getEventDays()).filter(eventDate ->
           ...
           // ImageUtils.loadResource(dayIcon, eventDay.getImageResource());
            mCalendarProperties.setSelectionColor(Color.parseColor("#FF4081"));
            DayColorsUtils.setEventDayColors(dayLabel, mCalendarProperties);
