...
public class DayColorsUtils {
    ...
    public static void setEventDayColors(TextView dayLabel, CalendarProperties calendarProperties) {
        setDayColors(dayLabel, calendarProperties.getSelectionLabelColor(), Typeface.NORMAL,
                R.drawable.background_color_circle_selector);

        dayLabel.getBackground().setColorFilter(calendarProperties.getEventColor(),
                android.graphics.PorterDuff.Mode.MULTIPLY);
    }
    /**
