...
public class CalendarView extends LinearLayout {
    ...
    public void clear() {
        ...
        mCalendarPageAdapter.setSelectedDay(new SelectedDay(Calendar.getInstance()));
    }
    private void reverseUnselectedColor(SelectedDay selectedDay) {
        ...
        for(EventDay d :mCalendarProperties.getEventDays())
            if(d.getCalendar().getTime().getTime()==selectedDay.getCalendar().getTime().getTime())
                DayColorsUtils.setEventDayColors((TextView) selectedDay.getView(),mCalendarProperties);
    }
    ...
    private void initCalendarProperties(TypedArray typedArray){
        ...
        int eventColor = typedArray.getColor(R.styleable.CalendarView_eventColor, 0);
        mCalendarProperties.setEventColor(eventColor);
